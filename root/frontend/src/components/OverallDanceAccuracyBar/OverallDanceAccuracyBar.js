...
const getDanceAccuracies = async (setDanceAccuracies) => {
  try {
    ...
    const moveAccuraciesOverall = await response.json()
    console.log(moveAccuraciesOverall)
    setDanceAccuracies(moveAccuraciesOverall.accuracies);
  } catch (err) {
...
const OverallDanceAccuracyBar = () => {
  ...
  useEffect(() => {
    getDanceAccuracies(setDanceAccuracies)
...
export default OverallDanceAccuracyBar 